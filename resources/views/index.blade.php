...
@section('container')
    ...
    <div class="carousel-inner">
        ...
        <img src="{{ ('img/home/rs1.jpeg') }}" class="d-block w-100 " alt="Responsive image" style="height:500px">
        ...
        <div class="carousel-item">
        <img src="{{ ('img/home/rs3.jpeg') }}" class="d-block w-100" alt="Responsive image" style="height:500px">
        <div class="carousel-caption d-none d-md-block">
